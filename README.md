...
- **Search Window (Compose)**  
  <img src="assets/1.jpg" alt="Search Window (Compose)" width="400"/>

- **Movie Information**  
  <img src="assets/2.jpg" alt="Movie Information" width="400"/>

- **TV Show Information**  
  <img src="assets/3.jpg" alt="TV Show Information" width="400"/>

- **TV Show Seasons**  
  <img src="assets/4.jpg" alt="TV Show Seasons" width="400"/>

- **Friend List Management Page**  
  <img src="assets/5.jpg" alt="Friend List Management Page" width="400"/>

- **Ability to Share Movie Information with a Friend via Messengers**  
  <img src="assets/6.jpg" alt="Share Movie Information" width="400"/>
...
- **Окно поиска (Compose)**  
  <img src="assets/1.jpg" alt="Окно поиска (Compose)" width="400"/>

- **Информация о фильме**  
  <img src="assets/2.jpg" alt="Информация о фильме" width="400"/>

- **Информация о сериале**  
  <img src="assets/3.jpg" alt="Информация о сериале" width="400"/>

- **Сезоны сериала**  
  <img src="assets/4.jpg" alt="Сезоны сериала" width="400"/>

- **Страница управления списком друзей**  
  <img src="assets/5.jpg" alt="Страница управления списком друзей" width="400"/>

- **Возможность отправки информации о фильме другу через Мессенджеры**  
  <img src="assets/6.jpg" alt="Возможность отправки информации о фильме другу через Мессенджеры" width="400"/>
