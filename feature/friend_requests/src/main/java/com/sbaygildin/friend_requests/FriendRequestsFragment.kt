...
import com.sbaygildin.friend_requests.databinding.FragmentFriendRequestsBinding
import com.sbaygildin.friend_requests.databinding.ItemFriendRequestBinding
    ...
    private fun updateFriendRequestsList(friends: List<Friend>) {
        ...
        for (friend in friends) {
            ...
            itemBinding.tvFriendEmail.setOnClickListener {
                (activity as com.sbaygildin.navigation.Navigator).navigateFriendRequestToShowMediaOfFriendId(
                    friend.id
                )
            }
