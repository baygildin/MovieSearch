package com.baygildins.friends_list
...
import com.baygildins.friends_list.databinding.FragmentFriendsListBinding
import com.baygildins.friends_list.databinding.ItemFriendListBinding
...
class FriendsListFragment : BaseFragment(R.layout.fragment_friends_list) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnLogOut.setOnClickListener {
            ...
            (activity as com.baygildins.navigation.Navigator).navigateFriendsListFragmentToSearchFragment()
        }
        binding.friendRequestsTextView.setOnClickListener {
            (activity as com.baygildins.navigation.Navigator).navigateFriendsListFragmentToFriendRequestsFragment()
        }
        binding.btnSearchFriend.setOnClickListener {
            (activity as com.baygildins.navigation.Navigator).navigateFriendListToSearchFriend()
        }
    }
    ...
    private fun updateFriendsList(friends: List<Friend>) {
        ...
        for (friend in friends) {
            ...
            itemBinding.tvEmailOfFriend.setOnClickListener {
                (activity as com.baygildins.navigation.Navigator).navigateFriendsListFragmentToShowMediaOfFriendId(
                    friend.id
                )
            }
