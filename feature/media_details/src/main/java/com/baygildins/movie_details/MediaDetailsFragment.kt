package com.baygildins.media_details
...
import com.baygildins.media_details.databinding.FragmentMediaDetailsBinding
...
class MediaDetailsFragment : BaseFragment(R.layout.fragment_media_details) {
    ...
    override fun onCreateView(
        ...
        binding.btnShowEpisodes.setOnClickListener {
            (activity as com.baygildins.navigation.Navigator).navigateMediaDetailsToShowSeasonsWithId(
                chosenMovieId
            )
        }

        binding.ivPoster.setOnClickListener {
            (activity as com.baygildins.navigation.Navigator).navigateMediaDetailsToPosterWithId(
                chosenMovieId
            )
        }
