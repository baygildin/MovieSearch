...
import com.baygildins.show_episodes.databinding.FragmentShowEpisodesBinding
                    ...
                    onSuccess = { episodesInfo ->
                        ...
                        for (episode in 1..episodesInfo.episodes.size) {
                            val button = Button(requireContext()).apply {
                                ...
                                setOnClickListener {
                                    (activity as com.baygildins.navigation.Navigator).navigateShowEpisodesToShowEpisode(
                                        episodesInfo.title,
