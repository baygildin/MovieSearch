...
import com.baygildins.show_episodes.databinding.FragmentShowSeasonsBinding
                        ...
                        for (season in 1..seasons.totalSeasons.toInt()) {
                            val button = Button(requireContext()).apply {
                                text = context.getString(
                                    R.string.seasons_text,
                                    context.getString(R.string.txt_season_preffix),
                                    season
                                )
                                setOnClickListener {
                                    (activity as com.baygildins.navigation.Navigator).navigateShowSeasonsToShowEpisodes(
