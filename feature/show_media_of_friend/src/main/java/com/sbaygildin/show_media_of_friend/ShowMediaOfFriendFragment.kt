...
import com.sbaygildin.show_media_of_friend.databinding.FragmentShowMediaOfFriendBinding
...
class ShowMediaOfFriendFragment : BaseFragment(R.layout.fragment_show_media_of_friend) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = ShowMediaOfFriendAdapter(emptyList()) { item ->
            val id = item.imdbId
            (activity as com.sbaygildin.navigation.Navigator).navigateShowMediaOfFriendToMediaDetailsWithId(
                id
            )
        }
